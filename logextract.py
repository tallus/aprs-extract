...
[[digipeater, latitude, longitude],date,log_count]
where date is extracted form file name and log_count is base 10 log the number of occurences of [digipeater, latitude, longitude] + 1 (so 1 occurence is not zero) rounded to two decimal places
"""
...
def reducer(key, list_of_values):
    count_val=round(log10(len(list_of_values))+1,2)
    mr.emit((key, date, count_val))
